...
- Cada um dos três domínios pode ser ligado/desligado individualmente na aba "Domínios" das configurações — útil se você só atende por uma das plataformas, ou quiser desligar o tema só dentro do chat.
